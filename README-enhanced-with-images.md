...
![Main menu and empty history](images/saved-history.png)
...
![Adding Mount Rushmore monument destination](images/add-monument.png)
...
![Adding Taj Mahal monument destination](images/add-monument-agra.png)
...
![Adding Aspen snow destination](images/add-snow.png)
...
![Saved destination records](images/database-records.png)
...
![Viewing trip history](images/trip-history.png)
...
![Saving and ending the session](images/save-exit.png)
